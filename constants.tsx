...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    investmentThesis: [
      'Overlooking the Aravallis, DLF Privana is a sanctuary of nature and architectural luxury.',
      'Designed for the discerning investor seeking long-term value creation in an emerging micro-market.',
      'Aravalli Views',
      'Integrated Township',
      'Sustainable Design',
